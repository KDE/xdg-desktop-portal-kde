...
private:
    std::unique_ptr<DataControlSource> m_source; // selection set locally
    std::unique_ptr<DataControlOffer> m_currentOffer; // latest selection set from externally to here
};
