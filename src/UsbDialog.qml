                ...
                delegate: QQC2.ItemDelegate {
                    ...
                    contentItem:  RowLayout {
                        ...
                        Kirigami.TitleSubtitle {
                            Layout.fillWidth: true
                            title:model.properties?.ID_MODEL_FROM_DATABASE ||  decodeString(model?.properties?.ID_MODEL_ENC) ||model.properties?.ID_MODEL_ID || ""
                            subtitle:model.properties?.ID_VENDOR_FROM_DATABASE || decodeString(model?.properties?.ID_VENDOR_ENC) ||model.properties?.ID_VENDOR_ID || ""
