...
void setWallpaper(const QUrl &url, WallpaperPortal::WallpaperLocation location)
{
    switch (location) {
    case WallpaperPortal::WallpaperLocation::Desktop:
        setDesktopBackground(url);
        break;
    case WallpaperPortal::WallpaperLocation::Lockscreen:
        setLockScreenBackground(url);
        break;
    case WallpaperPortal::WallpaperLocation::Both:
        setDesktopBackground(url);
        setLockScreenBackground(url);
        break;
    }
