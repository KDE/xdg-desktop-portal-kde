                                               ...
                                               bool allowRestore)
{
    ...
    auto continuation = [session, allowRestore, outputs, windows, selectedRegion](QList<QFuture<std::unique_ptr<ScreencastingStream>>> result) -> QVariantList {
        QVariantMap results;
